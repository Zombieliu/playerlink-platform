...
export default function Shoppingcart() {
    ...
    return (
        <div className="bg-white">
            ...
            <main className="max-w-2xl mx-auto pt-32 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <form className="mt-12 lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16">
                    ...
                    >
                        ...
                        <div className="mt-6">
                            <Link href="/payment">
                                <a>
                                    <div className="w-full bg-indigo-600 border border-transparent rounded-md shadow-sm text-center
                                    py-3 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500">
                                Checkout
                                    </div></a>
                            </Link>
                        </div>
