        ...
        <div className="min-h-screen bg-white">
            <header>
                <Popover className="relative bg-white">
                    <div className="flex fixed z-20 inset-x-0 bg-white justify-between items-center  mx-auto px-4 py-3 sm:px-6 md:justify-start md:space-x-10 xl:px-32">
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                            ...
                            <Popover.Group as="nav" className="hidden ml-4 md:flex space-x-10  ">

                                {navigation.map((item) => (
                                    <a key={item.name} href={item.href} className=" text-base rounded-lg p-2 font-medium text-black hover:bg-blue-500">
                                        {item.name}
                                    </a>
